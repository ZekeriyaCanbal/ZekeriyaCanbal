...
<html lang="en-US">
  <head>
    ...
    <title>Zekeriya CANBAL Github Readme.md</title>
    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Zekeriya CANBAL Github</a>
              <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-bar bar1"></span><span class="navbar-toggler-bar bar2"></span><span class="navbar-toggler-bar bar3"></span></button>
            </div>
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#about">Hakkımda</a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#skill">Becerilerim</a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#portfolio">Çalışmalarım</a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#experience">Deneyimlerim</a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#contact">İletişim</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          ...
          <div class="h2 title">Zekeriya CANBAL</div>
          <p class="category text-white">Web, Yazılım, Grafik Tasarımcı, Proje Yöneticisi</p><a class="btn btn-primary smooth-scroll mr-2" href="https://wa.me/905542720795" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">WhatsApp</a><a class="btn btn-primary" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Yardıma mı İhtiyacın Var?</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
    ...
    <div class="card" data-aos="fade-up" data-aos-offset="10">
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title">Hakkımızda</div>
            <p>Merhabalar! Zekeriya CANBAL freelancer (serbest) olarak çalışmaktayım. Yıllarca çalıştığım yerlerde sistem kurup faydalı olmaya çalıştım. Çeşitli zaman dilimlerinde BT ve IT olarak uzun yıllar çalıştım.</p>
            <p>Aktif olarak Web Tasarımı, Grafik Tasarımı, Sosyal Medya, E-Ticaret, Bilişim Teknolojileri Uzmanı, ve daha birçok beceriye sahibim. İşime çok tutkulu ve bağlıyım. 20 yıllık profesyonel bir deneyime, projenizi başarılı kılmak için gerekli beceri ve bilgilere sahibim. Çevremde ve iş hayatımdaki insanların güvenilir ve başladığı işi en iyi şekilde bitiren birisi olarak tanımlamaları bana gurur vermektedir. <a href="https://zekeriyacanbal.com.tr/" target="_blank">Daha Fazla Bilgi için</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title">İletişim Bilgilerim</div>
            <div class="row">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">zekeriacanbal@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Telefon:</strong></div>
              <div class="col-sm-8">+90(554) 272 07 95</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Adres:</strong></div>
              <div class="col-sm-8">Bornova, İZMİR, Türkiye</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">WEB:</strong></div>
              <div class="col-sm-8"><a href="https://zekeriyacanbal.com.tr/" target="_blank">zekeriyacanbal.com.tr</a>,<a href="https://zekademi.com" target="_blank">zekademi.com</a><a href="www.uzmanogretici.com" target="_blank">uzmanogretici.com</a></div>
            </div>
          </div>
        </div>
      </div>
...
<div class="section" id="skill">
  <div class="container">
    <div class="h4 text-center mb-4 title">Becerilerim & Bildiklerim</div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Photoshop</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 70%;"></div><span class="progress-value">95%</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 ml-auto mr-auto">
        <div class="h4 text-center mb-4 title">Çalışmalarım</div>
...
<div class="section" id="experience">
  <div class="container cc-experience">
    <div class="h4 text-center mb-4 title">Deneyimlerim</div>
    <div class="card">
      <div class="row">
...
<div class="section">
  <div class="container cc-education">
    <div class="h4 text-center mb-4 title">Eğitimlerim</div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
...
<div class="section" id="reference">
  <div class="container cc-reference">
    <div class="h4 mb-4 text-center title">Referanslarım</div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="card mb-0" data-aos="zoom-in">
              <div class="h4 text-center title">Bana Ulaşın</div>
              <div class="row">
                <div class="col-md-6">
                  <div class="card-body">
                    <form action="https://formspree.io/your@email.com" method="POST">
                      <div class="p pb-3"><strong>İletişime geçmekten çekinmeyin. </strong></div>
                      <div class="row mb-3">
                        <div class="col">
                          <div class="input-group"><span class="input-group-addon"><i class="fa fa-user-circle"></i></span>
                            <input class="form-control" type="text" name="name" placeholder="Ad Soyad" required="required"/>
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <div class="col">
                          <div class="form-group">
                            <textarea class="form-control" name="message" placeholder="Mesaj İçeriği" required="required"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Bornova, İZMİR/TÜRKİYE</p>
                    <p class="mb-0"><strong>Telefon</strong></p>
                    <p class="pb-2">+90 (554) 272 07 95</p>
                    <p class="mb-0"><strong>E-mail</strong></p>
                    <p>zekeriyacanbal@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Zekeriya CANBAL</div>
      <div class="text-center text-muted">
        <p>&copy; Creative Github</p>
      </div>
    </footer>
